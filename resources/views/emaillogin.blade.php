        ...
        <div class="card mb-3" style="max-width: 840px;">
            <div class="row g-0">
                ...
                <div class="col-md-6 colAuth rounded-end">
                    <div class="card-body">
                        <h3 class="card-title text-center">IDENTIFIANTS DE CONNEXION</h3>
                        ...
                        <div class="text-center">
                            <p class="fs-5 mt-4">Utilisez ces informations pour vous connecter à notre site.</p>
                            <p class="fs-5 mt-4">Veuillez les personnaliser une fois que vous êtes connectés.</p>
