...
<body>
    <div class="container-notification">
        <div class="card">
            ...
            <p> Nous vous encourageons à revoir nos conditions d'utilisation et à vous conformer à nos directives communautaires.</p>
            <p>Si vous avez des questions, contactez-nous à bamagid60@gmail.com.</p>
            <p>Nous espérons que vous comprendrez l'importance de maintenir un environnement harmonieux et sûr pour tous nos utilisateurs.</p>
            <p> Nous sommes prêts à vous aider à rétablir l'accès à votre compte une fois les problèmes résolus. Merci de votre coopération.</p>
